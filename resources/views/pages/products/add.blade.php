    ...
    <div class="main-content-inner">
        ...
        <div class="main-content-wrap bg-gray-100 pt-10 pb-20">
            <div class="w-10/12 lg:w-8/12 bg-white p-8 rounded-lg shadow-md mx-auto">
                ...
                <form action="{{ route('product.store') }}" method="POST" class="space-y-6" enctype="multipart/form-data">
                    @csrf
                    <div>
                    ...
                    <div>
                        ...
                        <textarea name="description[]" id="description"
                            ...
                            placeholder="Features Description" required>{{ old('description') }}</textarea>
                    </div>
